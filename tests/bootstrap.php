<?php
/**
 * Partners_Banner Test Bootstrapper.
 *
 * @since   1.0.0
 ...
 * @since 1.0.0
 */
function _manually_load_partners_banner_plugin() {
	...
	// Require our plugin.
	require dirname( dirname( __FILE__ ) ) . '/partners-banner.php';
}

// Inject in our plugin.
tests_add_filter( 'muplugins_loaded', '_manually_load_partners_banner_plugin' );
